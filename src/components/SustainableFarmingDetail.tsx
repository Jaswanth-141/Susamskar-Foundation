...
interface SustainableFarmingDetailProps {
  onBack: () => void;
  onOpenDonate: () => void;
...
export default function SustainableFarmingDetail({ 
  onBack, 
  onOpenDonate, 
  onOpenVolunteer,
  onNavigateToProject
}: SustainableFarmingDetailProps) {
    ...
    <div className="w-full bg-white text-slate-800">
      ...
      <section className="bg-brand-yellow rounded-b-[48px] sm:rounded-b-[64px] lg:rounded-b-[80px] pt-8 pb-20 px-4 sm:px-6 lg:px-8 text-left relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* Large display title */}
          <h1 className="font-display font-black text-slate-900 text-4xl sm:text-5xl lg:text-6xl tracking-tight max-w-4xl leading-tight uppercase">
            Sustainable Farming and<br />Community Welfare
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <p className="text-slate-600 text-base sm:text-lg leading-relaxed font-medium">
              Our Sustainable Farming and Community Welfare initiative aims to empower rural communities through awareness, self-sustenance, and compassion. In Balarampur village near Kharagpur, we are working closely with local farmers to promote sustainable multi-crop and organic farming practices that enhance both livelihood and environmental health.
            </p>
            <p className="text-slate-600 text-base sm:text-lg leading-relaxed">
              Alongside this, we organize community drives — including meal distributions, clothing support, and winter relief programs — to ensure holistic well-being. These efforts reflect our commitment to nurturing resilience, dignity, and hope in every household we serve.
            </p>
          </div>

          {/* Right: Farmers with white background and brush stroke style */}
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div>
              <h3 className="font-display font-black text-slate-800 text-xl sm:text-2xl tracking-tight uppercase border-l-4 border-[#00829a] pl-4 mb-3">
                Sustainable Farming Awareness
              </h3>
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                A pilot project has been initiated on the outskirts of Kharagpur, in Balarampur village, to spread awareness about sustainable multi-crop and organic farming practices. By guiding local farmers on practical, eco-friendly methods, the initiative helps improve soil health, productivity, and long-term sustainability.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                Through on-ground engagement and demonstrations, our volunteers educate farmers on the economic and environmental benefits of organic practices. The goal is to help them achieve self-sustenance, gain better value for their produce, and build a more stable livelihood.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                Our team regularly organizes the distribution of wholesome lunches to underprivileged families and primary school children in Balarampur — especially during festivals and special occasions. These efforts ensure that no one is left hungry while strengthening community bonds through shared care.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                During the colder months, we distribute blankets and warm clothes to around 200 villagers, including children and elders. The heartfelt gratitude we receive from the community continues to inspire us to expand these welfare activities and reach even more lives in the future.
              </p>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-50 border border-slate-100/80 rounded-[32px] p-6 sm:p-8 space-y-6 shadow-sm sticky top-6">
              ...
              <div className="space-y-4">
                {projectsData.filter(p => p.id !== 5).map((proj) => (
                  <div 
                    key={proj.id}
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Left: 2x2 Stats Grid from the screenshot */}
          <div className="lg:col-span-5 grid grid-cols-2 gap-x-6 gap-y-10 max-w-md mx-auto">
            {[
              { value: "3", label: "Cloth Distribution Drives" },
              { value: "200", label: "Meals Distributed" },
      ...
      <section className="py-20 bg-slate-50 border-t border-b border-slate-100 text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            {/* Middle Column Box (span 8/6): Value Education program in IIT Kgp */}
      ...
      {/* SECTION 7: APPRECIATION & RECOGNITION */}
      <section className="py-24 bg-brand-yellow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          {/* Beautiful Dot indicator with Nav Arrows */}
